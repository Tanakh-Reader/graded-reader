...
export const TEXT_SUBMITTED_BY_PASSAGE_SELECTOR_EVENT =
	"textSubmittedByPassageSelector";
export const PASSAGE_LISTS_TEXT_COMPARISON_EVENT = "passageListsTextComparison";
export const PASSAGE_LISTS_PENALTY_COMPARISON_EVENT =
	"passageListsPenaltyComparison";
