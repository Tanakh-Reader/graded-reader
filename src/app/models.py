...
class Word(models.Model):
    ...
    verb_tense = models.CharField(max_length=50, blank=True, null=True)
    verb_stem = models.CharField(max_length=50, blank=True, null=True)
    suffix_person = models.CharField(max_length=50, blank=True, null=True)
    suffix_gender = models.CharField(max_length=50, blank=True, null=True)
    suffix_number = models.CharField(max_length=50, blank=True, null=True)
    gloss = models.CharField(max_length=100, blank=True, null=True)
    ...
    lex = models.CharField(max_length=50, blank=True, null=True)
    name_type = models.CharField(max_length=50, blank=True, null=True)
    lex_set = models.CharField(max_length=50, blank=True, null=True)
    state = models.CharField(max_length=50, blank=True, null=True)
    language = models.CharField(max_length=50, blank=True, null=True)

    qere = models.CharField(max_length=50, blank=True, null=True)
    ketiv = models.CharField(max_length=50, blank=True, null=True)

    # Morphemes
    nominal_ending = models.CharField(max_length=50, blank=True, null=True)
    preformative = models.CharField(max_length=50, blank=True, null=True)
    pronominal_suffix = models.CharField(max_length=50, blank=True, null=True)
    univalent_final = models.CharField(max_length=50, blank=True, null=True)
    verbal_ending = models.CharField(max_length=50, blank=True, null=True)
    root_formation = models.CharField(max_length=50, blank=True, null=True)
